 ...
 * rendition — never load a full-res original into a small circle. `size` is
 * the on-screen point size; the rendition is requested at 2× for retina.
 * Non-Cloudinary URLs (or URLs without an `/upload/` segment) pass through
 * unchanged.
 */
